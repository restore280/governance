...
2. **Oversight Officers.**
   - CCO and CPO do not have direct reports but are responsible for gathering information across the organization to fulfill their roles.
...
3. **Teams and Projects.**
   - Employees assigned to company teams work collaboratively within those teams, but each member still reports directly to the CEO.
...
4. **Full-Time Employees.**
   ...
   - Work allocation shall be flexible:
     ...
     * Minimum 5 hours on approved company projects.
     * Remaining 10 hours allocated based on employee discretion and interest.
